...
kurubeeApp.config(function($routeProvider,RestangularProvider) {
    $routeProvider.
      ...
      when('/courses/:courseId/levels/:levelId/relational/:activityId', {
        templateUrl: 'partials/relational-activity-detail.html',
        controller: 'RelationalActivityCtrl'
      }).
      when('/courses/:courseId/levels/:levelId/relational', {
        templateUrl: 'partials/relational-activity-detail.html',
        controller: 'RelationalActivityCtrl'
      }).
      ...
      when('/players/:courseId/', {
        templateUrl: 'partials/player-stats.html',
        controller: 'PlayerStatsCtrl'
      }).
      when('/hours/:courseId/', {
        templateUrl: 'partials/hour-stats.html',
        controller: 'HourStatsCtrl'
      }).
      when('/days/:courseId/', {
        templateUrl: 'partials/day-stats.html',
