...
kurubeeServices.factory('Base64', function() {
...
kurubeeServices.service('loginService',['Base64','$http',
...
kurubeeServices.factory('Course', ['loginService','$resource', '$http',
  function(loginService, $resource, $http){
    return $resource('http://0.0.0.0:9090/api/v1/editorcareer/?format=jsonp:courseId', {}, {
	  query: {method:'GET', params:{courseId:'',username:loginService.getUsername,password:loginService.getPassword}, isArray:false}//, transformResponse: tastypieDataTransformer($http)} 
    });
  }]);
